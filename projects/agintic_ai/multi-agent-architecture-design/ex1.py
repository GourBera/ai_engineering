...
def create_diagram(title, nodes, edges, node_labels=None, node_types=None, edge_labels=None):
    ...
    # Use spring layout for automatic positioning if manual positions aren't sufficient
    pos = nx.spring_layout(graph, k=2, iterations=50, seed=42)
    
    # Override with manual positions for known nodes
...
def extended_uluru_exercise():
    ...
    edges = [
        ...
        ("Hindi Language Specialist", "Knowledge Base Lookup"),
        ("Bengali Language Specialist", "Knowledge Base Lookup"),
        ("Knowledge Base Lookup", "Hindi Language Specialist"),
        ("Knowledge Base Lookup", "Bengali Language Specialist"),
        ("Arrernte Language Specialist", "Knowledge Base Lookup"),
        ("Arrernte Language Specialist", "Knowledge Base Lookup"),
        ("Bengali to Hindi Translation", "Translation Tool"),
        ("Hindi to Bengali Translation", "Translation Tool"),
        ("Translation Tool", "Bengali to Hindi Translation"),
        ("Translation Tool", "Hindi to Bengali Translation"),
        ("Cultural Sensitivity Checker", "Bengali Language Specialist"),
        ("Cultural Sensitivity Checker", "Hindi Language Specialist"),
        ("Bengali Language Specialist", "Cultural Sensitivity Checker"),
        ("Hindi Language Specialist", "Cultural Sensitivity Checker"),
    ...
    node_types = {
        ...
        "Hindi Language Specialist": "agent",
        "Bengali Language Specialist": "agent",
        "Hindi to Bengali Translation": "tool",
        "Bengali to Hindi Translation": "tool",
        "Feedback Collector": "tool",
        "Cultural Sensitivity Checker": "agent",
        "Translation Tool": "tool",
    }

    edge_labels = {
        ("Language Identification", "Visitor Input"): "Formatted Response",
        ("Bengali to Hindi Translation", "Hindi to Bengali Translation"): "Translator",
        ("Hindi Language Specialist", "Cultural Sensitivity Checker"): "Checks Cultural Appropriateness",
        ("Bengali Language Specialist", "Cultural Sensitivity Checker"): "Checks Cultural Appropriateness",
    }
